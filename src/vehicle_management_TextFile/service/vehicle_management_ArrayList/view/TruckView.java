...
import static vehicle_management_Array.controller.VehicleController.TRUCK_REGEX;
import static vehicle_management_Array.controller.VehicleController.truckManager;

public class TruckView {
    private static final Scanner scanner = new Scanner(System.in);

    public static void showListTruck(List<Truck> trucks) {
